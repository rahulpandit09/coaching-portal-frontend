...
import { Lock, ArrowLeft, ShieldCheck, Eye, EyeOff, Mail } from "lucide-react"
          ...
          <div className="w-full max-w-[500px] animate-fade-in-up flex flex-col items-center relative lg:left-[-35px]">
            ...
            <div className="w-full bg-loginWhite/95 backdrop-blur-md rounded-2xl px-8 py-5 md:px-10 md:py-6 shadow-2xl border border-loginBorder overflow-hidden relative min-h-[350px] flex flex-col justify-center">
              ...
              <form onSubmit={formik.handleSubmit} className="space-y-3 animate-fields-in">
                {/* Email Address (editable or filled from query) */}
                <div>
                  <div className="relative flex items-center">
                    ...
                    <input
                      ...
                      disabled={loading || !!queryEmail}
                      className={`w-full py-2.5 pl-11 pr-4 bg-loginInput border rounded-xl text-sm focus:border-loginBlue outline-none transition-all text-loginText placeholder-loginMutedLight ${
                ...
                <div>
                  <div className="relative flex items-center">
                    ...
                    <input
                      ...
                      disabled={loading}
                      className={`w-full py-2.5 pl-11 pr-11 bg-loginInput border rounded-xl text-sm focus:border-loginBlue outline-none transition-all text-loginText placeholder-loginMutedLight ${
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`w-full py-2.5 mt-3 relative overflow-hidden rounded-xl font-bold text-loginWhite text-sm tracking-[0.2em] uppercase transition-all duration-300 border-0 outline-none flex items-center justify-center gap-2 ${
                    loading
